...
function App(props) {
  ...
  const [ethValue, setEthValue] = useState("0.5");
        ...
        <Switch>
          <Route exact path="/">
            ...
            <div style={{ padding: 8 }}>
              ...
              <input type={balanceStaked ? "success" : "primary"} placeholder="Enter ether value" onChange={getdata} />
              <button
                type={"default"}
                onClick={() => {
                  tx(writeContracts.Staker.stake({ value: ethers.utils.parseEther(ethValue) }));
                }}>Stake</button>
            ...
            <div style={{ padding: 8 }}>
              <button
                type={"default"}
                onClick={() => { tx(writeContracts.Staker.receiveFunds()); }} >
                Redeploy Repatriated funds
              </button>
            </div>

            <div style={{ padding: 8 }}>
              <button onClick={() => { tx(writeContracts.Staker.reDeploy()); }} >
                Restart
              </button>
            </div>
